...
{
    public class ProjectIndexViewController : ProjectViewModel, IMapFrom<MainTask>, IHaveCustomMappings
    {
        [Required]
        [UIHint("Number")]
        ...
        {
            configuration.CreateMap<MainTask, ProjectIndexViewController>("")
