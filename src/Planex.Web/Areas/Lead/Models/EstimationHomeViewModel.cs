...
{
    public class EstimationHomeViewModel : ProjectViewModel, IMapFrom<Data.Models.Project>, IHaveCustomMappings
    {
        public void CreateMappings(IConfiguration configuration)
        {
            configuration.CreateMap<Data.Models.Project, EstimationHomeViewModel>("")
